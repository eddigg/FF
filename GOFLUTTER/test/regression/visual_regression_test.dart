...
void main() {
  group('Visual Regression Tests', () {
    ...
    testWidgets('Dashboard page visual regression test', (WidgetTester tester) async {
      // Build the test app
    ...
    testWidgets('Navigation cards visual regression test', (WidgetTester tester) async {
      // Build the test app
      await tester.pumpWidget(
        TestApp(
          dashboardBloc: dashboardBloc,
      ...
      // Find and test the navigation grid
      await expectLater(
        find.byType(DashboardPage),
        matchesGoldenFile('navigation_cards.png'),
      );
    });

    testWidgets('Node selector visual regression test', (WidgetTester tester) async {
      // Build the test app
      await tester.pumpWidget(
        TestApp(
          dashboardBloc: dashboardBloc,
      ...
      // Find and test the node selector
      await expectLater(
        find.byType(DashboardPage),
        matchesGoldenFile('node_selector.png'),
      );
    });

    testWidgets('Network architecture section visual regression test', (WidgetTester tester) async {
      // Build the test app
      await tester.pumpWidget(
        TestApp(
          dashboardBloc: dashboardBloc,
      ...
      // Find and test the network architecture section
      await expectLater(
        find.byType(DashboardPage),
        matchesGoldenFile('network_architecture.png'),
      );
    });
  });
}