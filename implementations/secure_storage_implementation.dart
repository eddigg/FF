...
class SecureStorage {
  ...
  final String _encryptionKey = 'a-32-character-key-for-AES-256-enc'; // 32 chars for AES-256

  /// Writes a value to secure storage with encryption
  ...
  /// Reads a value from secure storage and decrypts it
